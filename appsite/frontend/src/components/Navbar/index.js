...
export default function Navbar() {
  return (
    <>
      <section className="overflow-hidden  z-10 w-full">
        <div className="flex items-center justify-between px-7 xl:px-40 py-5 bg-[#202020]  w-full">
            ...
            <div className="flex flex-wrap items-center">
              ...
              <div className="w-auto hidden lg:block">
                <ul className="flex items-center mr-16">
                  ...
                  <li className="mr-9 font-medium text-white hover:text-gray-200">
                    <Link href="/sobre-a-vox2you">Quem somos</Link>
                  </li>
                  <li className="mr-9 font-medium text-white hover:text-gray-200">
                  ...
                  <li className="mr-9 font-medium text-white hover:text-gray-200">
                    <a
                      target="_blank"
                      href="https://vox2you.com.br/blog"
                      rel="noreferrer"
                    >
                      Blog
                    </a>
            ...
            <div className="flex flex-wrap items-center">
              ...
              <div className="w-auto hidden lg:block">
                <div className="inline-block">
                  <a
                    target="_blank"
                    href="https://franquiadeoratoria.com.br/"
        ...
        <div className="hidden navbar-menu fixed top-0 left-0 bottom-0 w-4/6 sm:max-w-xs z-50">
          ...
          <nav className="relative z-10 px-9 pt-8 bg-[#202020] h-full overflow-y-auto">
